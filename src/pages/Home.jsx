    ...
    <div className="bg-white">
      ...
      <section className="relative py-24 bg-gradient-to-r from-charity-gold to-charity-gold-dark text-white overflow-hidden">
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="heading-xl mb-6">Vereinshaus Nasira e.V.</h1>

          <p className="body-lg text-white/90 max-w-3xl mx-auto leading-relaxed">
            Eine interkulturelle, interreligiöse und internationale Initiative
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-lg border border-charity-gold/10 hover:shadow-xl transition-shadow">
              ...
              <h3 className="font-semibold text-charity-dark mb-2">
                Integration
              </h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-charity-gold/10 hover:shadow-xl transition-shadow">
              ...
              <p className="text-sm text-gray-600">
                Hilfe für alle Menschen unabhängig von Herkunft
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-charity-gold/10 hover:shadow-xl transition-shadow">
              ...
              <p className="text-sm text-gray-600">
                Brücke zu wichtigen Hilfsangeboten
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border border-gray-100">
            <p className="body-lg text-gray-700 leading-relaxed">
              Das „Vereinshaus Nasira (Die Helferin) e.V." steht als
              interkulturelle, interreligiöse und internationale Initiative, die
              sich für die gesamte Gesellschaft engagiert – unabhängig von
              Hautfarbe, Herkunft oder Nationalität. Unser Angebot richtet sich
              gleichermaßen an zugewanderte Menschen wie auch an in Deutschland
              geborene Bürgerinnen und Bürger. Unser Ziel ist es, einen Raum zu
              schaffen, in dem Unterstützung und Gemeinschaft für alle geboten
              wird. Als Brücke zu wichtigen Hilfsangeboten und als Ort des
              Zusammenhalts fördern wir aktiv Integration und gesellschaftliche
              Teilhabe.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-6 body-base text-gray-700">
              ...
              <div className="pt-6 border-t border-gray-200 space-y-3">
                <p className="italic text-charity-dark">
                  Die Zwecke der Projekte dienen der Förderung der Hilfe zur
                  Selbsthilfe.
                </p>

                <p className="font-medium text-charity-dark">
                  Zweck des Vereins ist die selbstlose Förderung der genannten
                  Bereiche.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12">
            <div className="bg-white px-6 py-4 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              <img
                src="https://res.cloudinary.com/disaq3prz/image/upload/v1777278674/Logo_Vielfalt_Zentrum_ra1ltq.jpg"
                alt="WIR"
            ...
            <div className="bg-white px-6 py-4 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              <img
                src="https://res.cloudinary.com/disaq3prz/image/upload/v1777279381/Mastermind_1_utlubm.jpg"
                alt="Mastermind Presentations"
                className="h-16 w-auto object-contain"
              />
            </div>
            <div className="bg-white px-6 py-4 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              <img
                src="https://res.cloudinary.com/disaq3prz/image/upload/v1777279366/Mashood_Logo_1_bemgqx.png"
                alt="Mashood Ahmad"
                className="h-16 w-auto object-contain"
              />
            </div>
