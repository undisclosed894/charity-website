  ...
  const documents = [
    {
      ...
      viewOnly: true,
      viewUrl:
        "https://res.cloudinary.com/disaq3prz/image/upload/1._Auszug_aus_dem_Handelsregister_ycnsql.pdf",
    },
    {
      title: "Satzung",
      ...
      viewOnly: true,
      viewUrl:
        "https://res.cloudinary.com/disaq3prz/image/upload/2._Satzung_des_Vereins_Vereinshaus_Nasira_e._V._znffwg.pdf",
    },
    {
      title: "Konzeption",
      ...
      viewOnly: true,
      viewUrl:
        "https://res.cloudinary.com/disaq3prz/image/upload/3._Konzeption_Vereinshaus_Nasira_e._V._pzuslj.pdf",
    },
    {
      ...
      downloadUrl:
        "https://res.cloudinary.com/disaq3prz/image/upload/Mitgliedschaftsvereinbarung_Vereinshaus_Nasira_FINAL_vn9a2z.pdf",
    },
    {
      title: "Spendenkonto",
      ...
      downloadUrl:
        "https://res.cloudinary.com/disaq3prz/image/upload/5._Spendenkonto_Vereinshaus_Nasira_e._V._y8ww2u.pdf",
    },
    {
      ...
      downloadUrl:
        "https://res.cloudinary.com/disaq3prz/image/upload/6._Datenschutzklausel_Vereinshaus_Nasira_e._V._esibqj.pdf",
    },
  ];
      ...
      <section className="py-16 bg-gradient-to-r from-charity-gold to-charity-gold-dark text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="body-lg text-white/90">
            Offizielle Dokumente und Informationen zur Organisation unseres
            Vereins
          </p>
        </div>
      </section>
                ...
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <CardTitle className="text-charity-dark">
                          {doc.title}
                        </CardTitle>
                        <p className="text-sm text-charity-gray mt-1">
                          {doc.description}
                        </p>
                      </div>
                    </div>
